...
define dso_local void @axpy(i32 %0, float* %1, float* %2, float %3) #0 {
  ...
  call void @__tgt_target_data_update_nowait(i64 -1, i32 1, i8** %16, i8** %17, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @.offload_sizes, i32 0, i32 0), i64* getelementptr inbounds ([1 x i64], [1 x i64]* @.offload_maptypes, i32 0, i32 0))
...
declare dso_local void @__tgt_target_data_update_nowait(i64, i32, i8**, i8**, i64*, i64*)
