...
define dso_local void @axpy(i32 %0, float* %1, float* %2, float %3) #0 {
  ...
  %12 = getelementptr inbounds [1 x i8*], [1 x i8*]* %10, i32 0, i32 0
  %13 = bitcast i8** %12 to float***
  store float** %7, float*** %13, align 8
  %14 = getelementptr inbounds [1 x i8*], [1 x i8*]* %11, i32 0, i32 0
  %15 = bitcast i8** %14 to float***
  store float** %7, float*** %15, align 8
  %16 = getelementptr inbounds [1 x i8*], [1 x i8*]* %10, i32 0, i32 0
  %17 = getelementptr inbounds [1 x i8*], [1 x i8*]* %11, i32 0, i32 0
  call void @__tgt_target_data_update(i64 -1, i32 1, i8** %16, i8** %17, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @.offload_sizes, i32 0, i32 0), i64* getelementptr inbounds ([1 x i64], [1 x i64]* @.offload_maptypes, i32 0, i32 0))
...
declare dso_local void @__tgt_target_data_update(i64, i32, i8**, i8**, i64*, i64*)
