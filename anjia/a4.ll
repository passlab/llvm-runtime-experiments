...
define dso_local void @axpy(i32 %0, float* %1, float* %2, float %3) #0 {
  ...
  call void @__tgt_target_data_end(i64 -1, i32 1, i8** %24, i8** %25, i64* %26, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @.offload_maptypes, i32 0, i32 0))
